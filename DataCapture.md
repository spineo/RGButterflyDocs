...
[![RGButterfly Logo](images/RGButterfly_Logo.png)](https://spineo.github.io/RGButterflyDocs/) __Please note that the screenshots below are based on the _Tech_ version of the App though the functionality is basically the same.__
